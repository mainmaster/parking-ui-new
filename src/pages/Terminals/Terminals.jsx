...
import {useTerminalsQuery, useCreateTerminalMutation,useDeleteTerminalMutation, useEditTerminalMutation} from "api/terminal/terminal.api";
import {useSnackbar} from "notistack";
import {TerminalItem} from "./TerminalItem";
import css from '../CamerasPage/CamerasPage.module.scss'
...
export const Terminals = () =>{
    ...
    return(
       <div className='mb-3'>
           <Button className="mb-4 mt-3" onClick={()=>setModalActive(true)}>Добавить терминал</Button>
           <Modal
               show={modalActive}
               ...
               body={<Form onSubmit={submitForm}>
                   <Form.Group >
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, description: e.target.value})}
                       />
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, address: e.target.value})}
                       />
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, place: e.target.value})}
                       />
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, automat_number: e.target.value})}
                       />
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, ip_address: e.target.value})}
                       />
                       <Form.Label>Тип</Form.Label>
                        <Form.Select
                            onChange={(e)=> setTerminalsFormData(
                                {...terminalsFormData, terminal_type: e.target.value})}
                            name="terminal_type"
                            className='mb-3'
                        >
                       ...
                       <Form.Control
                           ...
                           onChange={(e)=> setTerminalsFormData(
                               {...terminalsFormData, port: e.target.value})}
                       />
                   ...
                   <Form onSubmit={submitEditTerminal}>
                       <Form.Group>
                           ...
                           <Form.Control
                               ...
                               onChange={(e)=> setTerminalEditData(
                                   {...terminalEditData, description: e.target.value})}
                           />
                           <Form.Label>Адрес</Form.Label>
                           <Form.Control
                               required
                               ...
                               onChange={(e)=> setTerminalEditData(
                                   {...terminalEditData, address: e.target.value})}
                           />
                           <Form.Label>Место</Form.Label>
                           <Form.Control
                               required
                               ...
                               onChange={(e)=> setTerminalEditData(
                                   {...terminalEditData, place: e.target.value})}
                           />
                           <Form.Label>Номер автомата</Form.Label>
                           <Form.Control
                               required
                               ...
                               onChange={(e)=> setTerminalEditData(
                                   {...terminalEditData, automat_number: e.target.value})}
                           />
                           <Form.Label>IP адрес</Form.Label>
                           <Form.Control
                               required
                               ...
                               onChange={(e)=> setTerminalEditData(
                                   {...terminalEditData, ip_address: e.target.value})}
                           />
                           <Form.Label>Тип</Form.Label>
                            <Form.Select
                                value={terminalEditData?.terminal_type}
                                onChange={(e)=> setTerminalEditData(
                                    {...terminalEditData, terminal_type: e.target.value})}
                                name="terminal_type"
                                className='mb-3'
                            >
                                <option value="aqsi">aqsi</option>

...
export const Renters = () =>{
    ...
    return(
        <div>
            <Button className="mb-4 mt-3" onClick={()=>setModalActive(true)}>Добавить арендатора</Button>
            <EditRenterModal show={showEditModal} handleClose={handleCloseEditModal}/>

            <Modal
                show={modalActive}
                handleClose={()=>setModalActive(false)}
                header={<CustomModal.Title>Создать арендатора</CustomModal.Title>}
                body={<Form ref={formRef} onSubmit={submitCreateRenter}>
                    <Form.Group >
                        ...
                        <Form.Control
                            ...
                            onChange={(e)=> setRenterFormData(
                                {...renterFormData, username: e.target.value})}
                        />
                        ...
                        <Form.Control
                            ...
                            onChange={(e)=> setRenterFormData(
                                {...renterFormData, password: e.target.value})}
                        />
                        ...
                        <Form.Control
                            ...
                            onChange={(e)=> setRenterFormData(
                                {...renterFormData, contacts: e.target.value})}
                        />
                        ...
                        <Form.Control
                            ...
                            onChange={(e)=> setRenterFormData(
                                {...renterFormData, company_name: e.target.value})}
                        />
            ...
            {renters && <Table titles={rentersTitles} rows={rentersRows(renters?.renters, activateRenter, deactivateRenter, editRenter)}/>}

            {renters && <PaginationCustom
                pages={renters.count}
                changePage={(e)=>{

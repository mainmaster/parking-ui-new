...
export let rentersRows = (renters, activateRenter, deactivateRenter, editRenter) =>{
    return renters?.map((renter)=>{
        return <tr key={renter.id} className={styles.operatorCard}>
            ...
            <td style={{ display: 'flex', gap: '10px', width: '250px', justifyContent: 'space-between'}}>
                <Button
